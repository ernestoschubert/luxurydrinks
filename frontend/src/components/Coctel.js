      ...
      <div className="mainCocktails">
        ...
        {props.getCocteles.respuesta.length > 0 ? (
                ...
                <div class="card">
                  <div class="additional">
                    <div class="user-card">
                      ...
                      <div class="points center">Sabor: {element.flour}</div>
                      <svg
                        width="110"
                        height="110"
                        viewBox="0 0 250 250"
                        xmlns={element.cocktailImg}
                        role="img"
                        aria-labelledby="title desc"
                        class="center"
                      >
                        <title id="title">{element.cocktailName}</title>
                        <desc id="desc">Image cocktail.</desc>
                        <style>
                          {/* .skin { fill: #eab38f; }
              .eyes { fill: #1f1f1f; }
              .hair { fill: #2f1b0d; }
          ...
          <div className="alert">
            <Alert variant="info">
              <p>
                Your coctel does not exist 🤷🏻‍♂️, try another cocktail, please. 🙂
              </p>
            </Alert>
          </div>
        )}
