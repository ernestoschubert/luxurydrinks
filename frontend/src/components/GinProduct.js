        ...
        <div class="m-10 flex flex-col items-center">
          ...
          <div class=" h-10 w-32 flex">
            <div class="flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1 items-center">
              <button onClick={disminuir} class=" bg-gray-300 text-gray-600 hover:text-gray-700 hover:bg-gray-400 h-full w-20 rounded-l cursor-pointer outline-none">
              ...
              <input
                ...
                value={value}
              />
              <button onClick={aumentar} class="bg-gray-300 text-gray-600 hover:text-gray-700 hover:bg-gray-400 h-full w-20 rounded-r cursor-pointer">
                <span class="m-auto text-2xl font-thin">+</span>
              </button>
            </div>
          </div>
