        ...
        <div class="bg-transparent p-0">
          <div class="md:flex p-20">
            <div class="md:w-6/12 text-white bg-red-600 p-8 sm:rounded-tr-lg md:rounded-tr-none md:rounded-bl-lg rounded-tl-lg flex items-center">
              <div>
                <h1 class="textCoctel mb-5 font-bold">
                  STRAWBERRIES & COCONUT CREAM
                </h1>
                <h2 class="textCoctel mb-12">
                  "UN COCKTAIL PARA CELEBRAR LOS SABORES FRESCOS DEL COCO, LA
                  FRAMBUESA Y BEEFEATER PINK STRAWBERRY GIN".
                </h2>
              </div>
            </div>
            <div class="md:w-6/12 relative">
              ...
              <img
                ...
                src="https://i.imgur.com/BeqfBBa.jpeg"
                width="20%"
                alt="Banner Desktop"
              />
            </div>
          ...
          <div class="md:flex p-20">
            <div class="md:w-6/12 relative">
              ...
              <img
                class="h-full w-full object-cover sm:rounded-bl-lg md:rounded-bl-none md:rounded-tr-lg rounded-br-lg"
                src="https://i.imgur.com/vASf97N.jpg"
                width="20%"
                alt="Banner Desktop"
              />
            </div>
            <div class="md:w-6/12 text-white bg-red-600 p-8 sm:rounded-tr-lg md:rounded-tr-none md:rounded-bl-lg rounded-tl-lg flex items-center">
              <div>
                ...
                <h2 class="textCoctel mb-12">
                  "EL DELICIOSO SABOR DE LA ALBAHACA Y EL GIN".
                </h2>
              </div>
            </div>
          </div>
